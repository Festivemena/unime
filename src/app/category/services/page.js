          ...
          <div className=" w-full">
            <div className="flex-1 w-full">
              {items.map((item, index) => (
                <div key={index} className='w-[90%] flex-1 rounded-lg bg-[#D9D9D9] justify-between my-2 ml-[5%] px-3'>
  ...
  return (
    <div>
      ...
      <div className='z-30 justify-between flex relative'>
        ...
        <div className='flex pt-1 font-semibold text-lg w-full pl-3'>Services</div>
      </div>
      <input
        type="text"
        value=""
