    ...
    <div className="w-full h-full">
      ...
      <div className="bg-white w-full h-[85%] rounded-tr-[50px] rounded-tl-[50px] mt-[15%]">
        ...
        <form onSubmit={handleSubmit} className="w-full px-8">
          ...
          <button
            type="submit"
            className="bg-[#FEC222] w-[90%] ml-[5%] mt-16 text-center font-bold text-lg h-[45px] rounded-lg text-white py-2"
          >
            Log In
          </button>
        </form>
        <div className="w-full text-right text-[#FEC222] pr-[5%] font-bold mt-1">
          Forgotten Password?
        </div>
        <div className="font-bold text-center text-md w-full text-wrap mt-12">
          ...
          <div
            ...
            className="text-[#FEC222] text-center cursor-pointer"
          >
            Sign Up
          </div>
        </div>
