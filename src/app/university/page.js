  ...
  return (
    <div className='bg-white w-full max-h-full'>
      ...
      <div className='flex-1 px-3 mt-3 w-full'>
        ...
        <div className='text-sm'>We will use this to show items & services available in your university/region</div>
      </div>
      <div>
      {/* <div>
      ...
      <div  onClick={() => {}} className='bg-[#FEC222] mx-3 mt-8 text-center py-3 text-white rounded-xl h-[50px]'>
        Continue
      </div>
    </div>
  )
